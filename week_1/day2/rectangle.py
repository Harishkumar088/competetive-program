...
def find_range_overlap(point1, length1, point2, length2):  
    ...
    maximumStartPoint = max(point1, point2)
    
    minimumEndPoint = min(point1 + length1, point2 + length2)
    
    if maximumStartPoint >= minimumEndPoint:
        return (None, None)  
        
    overlap_length = minimumEndPoint - maximumStartPoint
    return (maximumStartPoint, overlap_length)
